...
```python
# ============================
# বাংলা Voice + বাংলা Speech Recognition
# শুধু নিচের অংশগুলো replace করলেই হবে
# ============================
...
if not any(m.get("role") == "system" for m in memory):
    memory.insert(0, {
        "role": "system",
        "content": (
            f"তুমি JARVIS, {PERSONAL_INFO['name']} এর ব্যক্তিগত বাংলা AI assistant। "
            "সবসময় বাংলায় উত্তর দিবে। "
            "স্বাভাবিক মানুষের মতো কথা বলবে। "
            "সংক্ষিপ্ত, স্মার্ট ও helpful থাকবে। "
            "বাংলা এবং ইংরেজি দুই ভাষাই বুঝতে পারবে।"
        )
    })
...
def sr_callback(recognizer, audio):
    ...
    try:
        ...
        if text and len(text) > 2:
            ...
            threading.Thread(
                target=get_response_from_input,
                args=(text,),
                daemon=True
            ).start()
...
# -----------------------------
PERSONALITY_PROMPT = (
    "তুমি জারভিস, একজন স্মার্ট ও বন্ধুসুলভ বাংলা AI assistant। "
    "সবসময় স্বাভাবিক বাংলায় কথা বলবে। "
    "মানুষের মতো casual tone ব্যবহার করবে। "
    "সংক্ষিপ্ত, পরিষ্কার ও helpful উত্তর দিবে। "
    "প্রয়োজনে হালকা মজা করতে পারো কিন্তু বেশি না। "
    "ইমরানকে বন্ধুর মতো সাহায্য করবে।"
)


# -----------------------------
# বাংলা Startup Message
# -----------------------------
safe_insert(
    "জারভিস চালু হয়েছে। বাংলা ভয়েস ও বাংলা কথোপকথন সক্রিয়।"
)
...
# বাংলা Test
# -----------------------------
queue_tts("হ্যালো ইমরান, আমি এখন বাংলায় কথা বলতে পারি।")
```
...
PERSONALITY_PROMPT = (
    "তুমি জারভিস, একজন স্মার্ট ও বন্ধুসুলভ বাংলা AI assistant। "
    "সবসময় স্বাভাবিক বাংলায় কথা বলবে। "
    "সংক্ষিপ্ত, পরিষ্কার ও মানুষের মতো উত্তর দিবে। "
    "প্রয়োজনে হালকা মজা করতে পারো কিন্তু বেশি না। "
    "ইমরানকে সাহায্য করবে বন্ধুর মতো।"
)  
